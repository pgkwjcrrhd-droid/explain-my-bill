  ...
  return (
    ...
    >
      <button
        ...
        className="w-full rounded-xl border border-white/[0.04] bg-white/[0.01] hover:bg-white/[0.02] p-4 flex items-center gap-3 transition-colors"
      >
        <Info className="w-4 h-4 text-slate-500 flex-shrink-0" />
        <span className="text-sm text-slate-500 font-medium flex-1 text-left">Prototype Notes & Data Provenance</span>
      ...
      <AnimatePresence>
        {isOpen && (
          ...
          >
            <div className="mt-2 rounded-xl border border-white/[0.04] bg-white/[0.01] p-6 space-y-4">
              <div>
                <h4 className="text-xs font-bold text-green-400 uppercase tracking-wider mb-2">Grounded in Real Data</h4>
              ...
              <div>
                <h4 className="text-xs font-bold text-amber-400 uppercase tracking-wider mb-2">Demo Interpretations</h4>
                <p className="text-xs text-slate-400 leading-relaxed">
              ...
              <div>
                <h4 className="text-xs font-bold text-blue-400 uppercase tracking-wider mb-2">Authentication</h4>
                <p className="text-xs text-slate-400 leading-relaxed">
              ...
              <div>
                <h4 className="text-xs font-bold text-purple-400 uppercase tracking-wider mb-2">Future-State Features</h4>
                <p className="text-xs text-slate-400 leading-relaxed">
