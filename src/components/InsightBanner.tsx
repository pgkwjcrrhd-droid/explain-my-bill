  ...
  return (
    ...
    >
      ...
      <div className="relative overflow-hidden rounded-2xl border border-white/[0.06] bg-gradient-to-br from-slate-900/80 via-slate-900/60 to-blue-950/30 backdrop-blur-sm">
        {/* Subtle glow */}
        <div className="absolute top-0 right-0 w-40 sm:w-64 h-40 sm:h-64 bg-blue-500/[0.05] rounded-full blur-[60px] sm:blur-[80px] pointer-events-none" />
        ...
        <div className="relative p-5 sm:p-8">
          <div className="flex items-start gap-3 mb-4 sm:mb-6">
            ...
            <div>
              <h3 className="text-xs sm:text-sm font-semibold text-amber-400 tracking-wide uppercase mb-1">Bill Intelligence</h3>
          ...
          <div className="mb-4 sm:mb-6">
            <p className="text-xs font-semibold text-slate-500 uppercase tracking-wider mb-2.5 sm:mb-3">Top 3 Drivers of Change</p>
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-2.5 sm:gap-3">
              {drivers.map((driver, idx) => (
                <motion.div
                  ...
                  className="bg-white/[0.03] border border-white/[0.06] rounded-xl p-3.5 sm:p-4"
                >
                  ...
                  <p className="text-sm font-medium text-white mb-0.5 sm:mb-1">{driver.label}</p>
          ...
          <div className="bg-white/[0.02] border border-white/[0.04] rounded-xl p-3.5 sm:p-4">
            ...
            <div className="flex flex-wrap gap-1.5 sm:gap-2">
              {[
                ...
                <span key={i} className="text-xs px-2.5 sm:px-3 py-1.5 rounded-full bg-blue-500/[0.08] border border-blue-500/[0.15] text-blue-300 cursor-default">
                  {q}
                </span>
              ))}
            </div>
